...
python-minifier currently supports Python 2.7 and Python 3.3 to 3.9. Previous releases supported Python 2.6.
...
python-minifier runs with and can minify code written for Python 2.7 and Python 3.3 to 3.9.
